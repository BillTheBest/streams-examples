 ...
 */
public class ActorEnrich implements Runnable {

    private final static Logger LOGGER = LoggerFactory.getLogger(ActorEnrich.class);

    public static void main(String[] args)
    {
        ActorEnrich job = new ActorEnrich();
    ...
    public void run() {
        ...
        StreamBuilder builder = new LocalStreamBuilder(new LinkedBlockingQueue<StreamsDatum>(2), streamConfig);
        ...
        builder.addStreamsProcessor("accountTypeProcessor", accountTypeProcessor, 1, "provider");
