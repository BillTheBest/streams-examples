 ...
 */
public class FacebookUserstreamElasticsearch {

    private final static Logger LOGGER = LoggerFactory.getLogger(FacebookUserstreamElasticsearch.class);
    ...
    public static void main(String[] args)
    {
        ...
        FacebookUserstreamProvider provider = new FacebookUserstreamProvider(facebookUserstreamConfiguration, ObjectNode.class);
